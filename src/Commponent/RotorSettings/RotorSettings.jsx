      ...
      {rotors.map((num ,index) => (
        <div className={styles.rotorInput} key={index}>
          ...
          <input
            ...
            onChange={(e) => setRotorStart( num.name, e.target.value.toUpperCase())}
          ...
          <div className={styles.alphabetDisplay}>
            <div className={styles.staticAlphabet}>
              {alphabetStatic.split("").map((char, index) => (
                <span key={index} className={styles.staticLetter} data-letter={char}>
                  {char}
                </span>
              ))}
            </div>
            <div className={styles.dynamicAlphabet}>
              {num.value.map((char, index)=>(<span key={index} className={styles.staticLetter} data-letter={char}>
                  {char}
                </span>))}
            </div>
          </div>
